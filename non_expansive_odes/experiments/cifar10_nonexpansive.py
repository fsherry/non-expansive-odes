...
from non_expansive_odes.utils.loggers import (
    log_dynamic_blocks,
    log_gradient_norms,
    log_linear_layers,
)
...
if __name__ == "__main__":
    ...
    while True:
        for x, y in train_loader:
            ...
            log_linear_layers(model, run, iterate)
            wandb.log(
                {
                    "train/loss": loss,
                    "train/acc": acc,
        ...
        if not params["test_lr"]:
            ...
            certified_robust = certified_robustness(
                model, val_loader, epsilons, model.lipschitz_const
            )
